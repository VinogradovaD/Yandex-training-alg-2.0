# [A. Interactor](https://github.com/VinogradovaD/Yandex_training_alg_2.0/blob/main/Занятие%201/A.java)
...
# [B. Кольцевая линия метро](https://github.com/VinogradovaD/Yandex_training_alg_2.0/blob/main/Занятие%201/B.java)
...
# [C. Даты](https://github.com/VinogradovaD/Yandex_training_alg_2.0/blob/main/Занятие%201/C.java)
...
# [D. Строительство школы](https://github.com/VinogradovaD/Yandex_training_alg_2.0/blob/main/Занятие%201/D.java)
...
## Формат ввода
Сначала вводится число N — количество учеников (0 < N < 100001). Далее идут в строго возрастающем порядке координаты домов учеников — целые числа, не превосходящие 2 x 10^9 по модулю. 
...
# [E. Точка и треугольник](https://github.com/VinogradovaD/Yandex_training_alg_2.0/blob/main/Занятие%201/E.java)
